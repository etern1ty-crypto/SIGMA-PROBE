...
тЭМ Import failed: name 'ActorProfile' is not defined


ЁЯФН Testing data models...
тЭМ Data model test failed: name 'ActorProfile' is not defined


ЁЯФН Testing rules engine...
тЭМ Rules engine test failed: name 'ActorProfile' is not defined
...
тЭМ Pipeline initialization failed: name 'ActorProfile' is not defined
...
==================================================
ЁЯУК Test Results: 3/7 tests passed
